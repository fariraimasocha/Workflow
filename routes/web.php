...
Route::get('/projectrequests/create', [FrontendProjectRequestController::class, 'create'])->name('projectrequests.create');
Route::post('/projectrequests/create', [FrontendProjectRequestController::class, 'storecreate'])->name('projectrequests.store.create');
