    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                <form method ="POST" action="{{ route('admin.steps.store') }}" enctype="multipart/form-data w-1/2">
                  @csrf
                  ...
                  <div class="sm:col-span-6 pt-5">
                    ...
                    <div class="mt-1">
                       ...
                       <select id="projects" name="projects[]" class="form-multiselect block w-full mt-1"
                        multiple>
